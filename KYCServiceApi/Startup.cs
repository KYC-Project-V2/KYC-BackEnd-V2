...
namespace KYCServiceApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IService<LoginUser>, LoginService>();
            services.AddTransient<IRepository<LoginUser>, LoginRepository>();
            ...
            services.AddTransient<IService<Dashboard>, DashboardService>();
            services.AddTransient<IRepository<Dashboard>, DashboardRepository>();
